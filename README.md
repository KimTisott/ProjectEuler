...
| Problem                                   | Solution                                                                         | Mean (ns)     | Error (ns)  | StdDev (ns) | Code (B) | Alloc (B) |
| :---------------------------------------: | :------------------------------------------------------------------------------: | ------------: | ----------: | ----------: | -------: | --------: |
...
| [9](https://projecteuler.net/problem=9)   | [C#](https://github.com/KimTisott/ProjectEuler/blob/main/Solutions/Problem9.cs)  |      53.877   |      0.1598 |      0.1494 |      256 | -         |
| [10](https://projecteuler.net/problem=10) | [C#](https://github.com/KimTisott/ProjectEuler/blob/main/Solutions/Problem10.cs) | 4,701,104.353 | 34,315.7461 | 30,420.0151 |      234 | 2,000,024 |
